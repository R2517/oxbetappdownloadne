...
const Casino = () => (
  <Layout>
      ...
      <div className="container-narrow text-center">
        <ScrollReveal>
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="gold-text">1xBet Casino</span> — 5,000+ Games Online
          </h1>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-8">
            Explore the complete 1xBet online casino experience with thousands of slots, table games, progressive jackpots, and exclusive titles from world-class providers. Play on mobile or desktop with the best odds and fastest payouts.
          </p>
          <CTAButton text="Play Casino Now" size="lg" />
        </ScrollReveal>
      </div>
    </section>
    ...
    <section className="section-padding bg-gradient-to-b from-primary/10 to-transparent text-center">
      <GlowOnScroll>
        <div className="container-narrow">
          <h2 className="text-3xl font-bold mb-4">Start Playing Casino Games Today</h2>
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
            <a href="#AFFILIATE_LINK_PLACEHOLDER" className="text-primary hover:underline">Install the 1xBet casino app</a> and access 5,000+ games, exclusive bonuses, and the best online casino experience on your mobile device.
          </p>
          <CTAButton text="Download Casino App" size="lg" />
        </div>
      </GlowOnScroll>
    </section>
  </Layout>
