  ...
  <Layout>
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Disclaimer", item: "https://1xbetapp.one/disclaimer" },
      ]
    })}} />
    ...
    <section className="section-padding pt-0">
      <div className="container-narrow max-w-3xl">
        ...
        <p className="text-muted-foreground mb-6">The following disclaimer applies to all content, services, and information provided on the 1xbetapp.one website. Please read this disclaimer carefully before using our website.</p>

        <h2 className="text-xl font-bold mt-8 mb-3">1. General Information Disclaimer</h2>
        <p className="text-muted-foreground mb-4">The information provided on 1xbetapp.one is for general informational and educational purposes only. While we make every effort to keep the information accurate, complete, and up to date, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability, or availability of the information, products, services, or related graphics contained on this website for any purpose. Any reliance you place on such information is therefore strictly at your own risk.</p>
