...
const LiveCasino = () => (
  <Layout>
      ...
      <div className="container-narrow text-center">
        <ScrollReveal>
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="gold-text">1xBet Live Casino</span> — Real Dealers, Real Action
          </h1>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-8">
            Experience the thrill of a real casino from anywhere. Play live roulette, blackjack, baccarat, and game shows with professional dealers streaming in HD quality. The ultimate live casino experience on your mobile device.
          </p>
          <CTAButton text="Play Live Casino" size="lg" />
        </ScrollReveal>
      </div>
    </section>
      ...
      <div className="container-narrow">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <ScrollReveal direction="left">
            ...
            <p className="text-muted-foreground mb-4">
              With over 200 live tables running 24/7, powered by industry leaders like Evolution Gaming, Pragmatic Play Live, and Ezugi, you'll always find a seat at your favorite game. From classic table games to innovative game shows, the live casino section offers the most engaging online gaming experience available.
            </p>
    ...
    <section className="section-padding gradient-section">
      <div className="container-narrow max-w-4xl">
        ...
        <ScrollReveal delay={0.05}>
          ...
          <p className="text-muted-foreground mb-4">Choose from dozens of roulette tables including European, American, and French variants. Specialty tables like Lightning Roulette add random multipliers up to 500x on straight-up bets, creating explosive winning potential. Speed Roulette and Auto Roulette offer faster-paced alternatives for players who prefer quick rounds.</p>
        </ScrollReveal>
        <ScrollReveal delay={0.1}>
          <h3 className="text-xl font-semibold mt-6 mb-3">Live Blackjack</h3>
          <p className="text-muted-foreground mb-4">Multiple blackjack tables cater to all budgets, from low-stakes public tables to exclusive VIP rooms with limits up to $500,000 per hand. Side bets, Perfect Pairs, and 21+3 options add extra excitement. Bet Behind allows you to wager on other players' hands when tables are full.</p>
        </ScrollReveal>
        <ScrollReveal delay={0.15}>
          <h3 className="text-xl font-semibold mt-6 mb-3">Live Baccarat</h3>
          <p className="text-muted-foreground mb-4">Experience the elegance of baccarat with professional dealers. Speed Baccarat completes rounds in 25 seconds, while Lightning Baccarat introduces random multipliers. Side bets and squeeze features enhance the traditional gameplay.</p>
        </ScrollReveal>
        <ScrollReveal delay={0.2}>
          <h3 className="text-xl font-semibold mt-6 mb-3">Live Game Shows</h3>
          <p className="text-muted-foreground mb-6">The most innovative category in live gaming. Crazy Time features four bonus rounds with massive multiplier potential. Dream Catcher is a simple money wheel game perfect for beginners. Mega Ball combines bingo with live lottery draws. These games blend entertainment with real money gaming for a unique experience.</p>
    ...
    <section className="section-padding">
      <div className="container-narrow max-w-4xl">
        <ScrollReveal>
          ...
          <p className="text-muted-foreground mb-4">The live casino streams in HD quality with adaptive bitrate technology. The app automatically adjusts video quality based on your connection speed, ensuring smooth gameplay whether you're on high-speed WiFi or mobile data. Multiple camera angles let you see the action from different perspectives.</p>
          <p className="text-muted-foreground mb-6">On tablets, the landscape mode provides the most immersive experience with larger video feeds and easier chip placement. Portrait mode on smartphones is optimized for one-handed play with all controls within thumb reach.</p>
        </ScrollReveal>
    ...
    <section className="section-padding bg-gradient-to-b from-primary/10 to-transparent text-center">
      <GlowOnScroll>
        <div className="container-narrow">
          <h2 className="text-3xl font-bold mb-4">Join the Live Casino Action</h2>
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
            <a href="#AFFILIATE_LINK_PLACEHOLDER" className="text-primary hover:underline">Download the 1xBet app</a> and experience real dealers, real cards, and real excitement — all from your mobile device. Explore <Link to="/casino" className="text-primary hover:underline">all casino games</Link> or check <Link to="/sports-betting" className="text-primary hover:underline">sports betting</Link> options.
          </p>
