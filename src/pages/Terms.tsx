  ...
  <Layout>
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Terms & Conditions", item: "https://1xbetapp.one/terms" },
      ]
    })}} />
    ...
    <section className="section-padding pt-0">
      <div className="container-narrow max-w-3xl">
        ...
        <p className="text-muted-foreground mb-6">Please read these Terms and Conditions ("Terms") carefully before using the 1xbetapp.one website ("Service"). By accessing or using the Service, you agree to be bound by these Terms. If you disagree with any part of these Terms, you must discontinue use of the website immediately.</p>
        ...
        <p className="text-muted-foreground mb-4">To the fullest extent permitted by applicable law, 1xbetapp.one and its owners, operators, employees, and agents shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, goodwill, or other intangible losses resulting from: (a) your use or inability to use the website; (b) any content obtained from the website; (c) unauthorized access to or alteration of your data; or (d) any other matter relating to the website.</p>
